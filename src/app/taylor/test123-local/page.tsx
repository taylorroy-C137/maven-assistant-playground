...
export default function Test123LocalPage() {
  return (
    <ScreenShell>
      <FreyaNavBar />
      ...
      <div className="px-4 flex flex-col gap-6 pb-6">
        ...
        <div>
          ...
          <FreyaCarousel dotCount={3} activeDot={0}>
            ...
            <FreyaContentCard
              badge="Wellness"
              subjectTag="MENTAL HEALTH"
              title="Managing mood changes during your GLP-1 treatment"
        ...
        <div>
          ...
          <FreyaCarousel dotCount={3} activeDot={0}>
            <FreyaContentCard
              badge="Exercise"
              subjectTag="FITNESS"
              title="Low-impact workouts that complement GLP-1 treatment"
              timeLabel="6 min read"
            />
            <FreyaContentCard
              badge="Sleep"
              subjectTag="RECOVERY"
              title="How better sleep can accelerate your weight loss results"
              timeLabel="4 min read"
            />
            <FreyaContentCard
              badge="Community"
              subjectTag="STORIES"
              title="Real members share their first 90 days on Maven"
