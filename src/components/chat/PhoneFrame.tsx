  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Time — left of Dynamic Island, vertically centered with it */}
        <div
          className="absolute z-50 flex items-center text-maven-text"
        ...
        {/* Status icons — right of Dynamic Island, vertically centered with it */}
        <div
          className="absolute z-50 flex items-center text-maven-text"
          style={{ top: 17, right: 24 }}
        >
          <StatusIcons />
        </div>

        {/* App content — starts below Dynamic Island */}
        <div
